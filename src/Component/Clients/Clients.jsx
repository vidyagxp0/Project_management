  ...
  const [data,setData]=useState( [
    {
      ...
      lastName: "Jat",
      userName: "Pankaj@123",
      companyName: "Vidyagxp",
      companyMail: "Admin@vidyagxp.com",
    ...
    },
    {
      ...
      lastName: "Rathore",
      userName: "Mr-2704",
      companyName: "Life link digital",
      companyMail: "hr@lifelink.com",
      department: "Admin (Administration)",
      ...
      <div className="p-4">
        ...
        <div className="p-4 shadow-2xl">
          <div className="flex justify-between p-2">
            <div className="text-[22px] font-semibold">Clients</div>
            <div className="flex gap-4">
              <div className="bg-emerald-100 p-2 rounded text-emerald-500 cursor-pointer">
                <RiAddFill onClick={() => navigate("/add-Clients")} />
              </div>
            </div>
          </div>
